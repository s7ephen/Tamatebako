#!/usr/bin/env python
__doc2__ = """
    Right now this serial snoop is only CLI ripped directly from Eric Monti's
ttyproxy (/home/svn/toolshed/ttytools/ttyproxy.py). Eventually (when I can
figure out how to completely embed a cli.CLI() prompt into a tk TextBox 
I would like to pop up a window when data hits the select(). for now though
I have done it with code.interact().
